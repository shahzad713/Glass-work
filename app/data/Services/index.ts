import { servcicesListType } from "./types";

export const servicesList: servcicesListType[] = [
  {
    ...
    description: `
      ...
      `,
    direction: "left",
    image: "/Images/Services/services/design/1.png",
  },
  {
...
With our professional and expert designers, we provide to our client a complete detailed shop drawings, production drawings and as build drawings.
      `,
    direction: "right",
    background: "bg-[#193c635]",
    image: "/Images/Services/services/fabrication/1.png",
  },
  {
...
With our professional and expert designers, we provide to our client a complete detailed shop drawings, production drawings and as build drawings.
      `,
    direction: "left",
    image: "/Images/Services/services/logistics/1.png",
  },
  {
    title: "Supplly Only",
    description: `
...
With our professional and expert designers, we provide to our client a complete detailed shop drawings, production drawings and as build drawings.
    ...
    direction: "right",
    background: "bg-[#193c635]",
    image: "/Images/Services/services/supply/1.png",
  },
];
